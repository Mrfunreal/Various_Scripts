...
//	This is taken from https://steamcommunity.com/sharedfiles/filedetails/?id=1311275220 and just rehosted here for preservation. No context provided.
...
if SERVER then
	...
	VC.Extra_Temp_AmphV_List = {
		"models/sentry/l4dapc.mdl", //This probably determines what vehicle its used on. idk.
	}
